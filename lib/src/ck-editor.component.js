...
var CkEditorComponent = /** @class */ (function () {
    ...
    CkEditorComponent.prototype.registerHandle = function (editor) {
        ...
        var toolbarElement;
        var normalToolbar = editor.ui.view.toolbar;
        if (normalToolbar) {
            toolbarElement = normalToolbar.element;
        }
        else {
            var balloonElementSet = editor.ui.focusTracker._elements;
            var balloonElementArr = this.set2Array(balloonElementSet);
            var balloonToolbar = balloonElementArr[2];
    ...
    CkEditorComponent.prototype.set2Array = function (set) {
        var arr = [];
        if (set.size > 0) {
